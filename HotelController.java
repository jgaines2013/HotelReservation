 ...
 * Controller
 */
public class HotelController implements PropertyChangeListener {
    ...
    public HotelController(HotelModel model, MainView mainView) {
        this.model = model;
...
//******************needs to be changed later************************
        final ActionListener saveButtonListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    Reservation node = new Reservation(name, startTime, endTime);
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        // Changed date 
        //****** can be changed to show booked rooms that day
